...
empleados[0].Apellido = "Toll";
empleados[0].Nombre = "Luciana";
...
empleados[1].Apellido = "Barbosa";
empleados[1].Nombre = "Sandra";
...
empleados[2].Apellido = "De La Cruz";
empleados[2].Nombre = "Federico";
empleados[2].Fecha_nacimiento = new DateTime(2002, 5, 26);
empleados[2].Estado_civil = 'S';
empleados[2].Genero = 'M';
